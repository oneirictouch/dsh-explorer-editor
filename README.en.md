...
<p align="center">
  <a href="https://github.com/oneirictouch/dsh-explorer-editor/releases"><img alt="version" src="https://img.shields.io/badge/version-0.11.0-0969da?style=flat" /></a>
...
```sh
dsh plugin --profile web add ./dsh-explorer-editor-0.11.0.tgz
```
